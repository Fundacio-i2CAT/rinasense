...
/* Struct definitions */
typedef struct _rina_messages_string_t
{                        /* information to identify an string */
...
typedef struct _rina_messages_int_t
{                   /* information to identify an int */
    uint32_t value; /* value of the integer */
} rina_messages_int_t;

typedef PB_BYTES_ARRAY_T(1024) rina_messages_objVal_t_byteval_t;
typedef struct _rina_messages_objVal_t
{ /* value of an object */
    bool has_intval;
    int32_t intval;
    bool has_sintval;
...
#define rina_messages_objVal_t_init_default                                                              \
    {                                                                                                    \
        false, 0, false, 0, false, 0, false, 0, false, "", false, {0, {0}}, false, 0, false, 0, false, 0 \
    }
...
#define rina_messages_CDAPMessage_init_default                                                                                                                                                                                                                                                                                                                               \
    {                                                                                                                                                                                                                                                                                                                                                                        \
        false, 0, _rina_messages_opCode_t_MIN, false, 0, false, _rina_messages_flagValues_t_MIN, false, "", false, "", false, 0, false, rina_messages_objVal_t_init_default, false, 0, false, 0, {{NULL}, NULL}, false, rina_messages_authPolicy_t_init_default, false, "", false, "", false, "", false, "", false, "", false, "", false, "", false, "", false, "", false, 0 \
    }
#define rina_messages_int_t_init_default \
    {                                    \
        0                                \
    }
#define rina_messages_string_t_init_default \
    {                                       \
        {                                   \
            {NULL}, NULL                    \
        }                                   \
    }
#define rina_messages_objVal_t_init_zero                                                                 \
    {                                                                                                    \
        false, 0, false, 0, false, 0, false, 0, false, "", false, {0, {0}}, false, 0, false, 0, false, 0 \
    }
...
#define rina_messages_CDAPMessage_init_zero                                                                                                                                                                                                                                                                                                                            \
    {                                                                                                                                                                                                                                                                                                                                                                  \
        false, 0, _rina_messages_opCode_t_MIN, false, 0, false, _rina_messages_flagValues_t_MIN, false, "", false, "", false, 0, false, rina_messages_objVal_t_init_zero, false, 0, false, 0, {{NULL}, NULL}, false, rina_messages_authPolicy_t_init_zero, false, "", false, "", false, "", false, "", false, "", false, "", false, "", false, "", false, "", false, 0 \
    }
#define rina_messages_int_t_init_zero \
    {                                 \
        0                             \
    }
#define rina_messages_string_t_init_zero \
    {                                    \
        {                                \
            {NULL}, NULL                 \
        }                                \
...
#define rina_messages_objVal_t_size 1103
